  ...
  return (
    <div>
      ...
      <div className='about-grid'>
        <div className='shadow-md'><img src={chapel} alt="" /></div>
        ...
        <div className='shadow-md'><img src={dining} alt="" /></div>
        <div className='shadow-md'><img src={room} alt="" /></div>
        <div className='centered-text'>
        ...
        <div className='shadow-md'><img src={lecture} alt="" /></div>
      </div>
